...
const HERO_IMAGE = "/assets/images/v2/project-featured-images/one/the-one.webp";
...
const THE_ONE_GALLERY: GalleryMonth[] = [
  {
    month: "February 2026",
    images: [
      `${CU}/the-one-construction-updates-feb-2026-2.webp`,
      `${CU}/the-one-construction-updates-feb-2026-6.webp`,
      `${CU}/the-one-construction-updates-feb-2026-4.webp`,
      `${CU}/the-one-construction-updates-feb-2026-3.webp`,
      `${CU}/the-one-construction-updates-feb-2026-1.webp`,
    ],
  },
  {
    month: "August 2025",
    images: [
      `${CU}/The-One-Construction-Update-11.webp`,
      `${CU}/The-One-Construction-Update-1.webp`,
      `${CU}/The-One-Construction-Update-3.webp`,
      `${CU}/The-One-Construction-Update-4.webp`,
      `${CU}/The-One-Construction-Update-6.webp`,
      `${CU}/The-One-Construction-Update-7.webp`,
    ],
  },
  {
    month: "June 2025",
    images: [
      `${CU}/THE-ONE-C-U-11-scaled.webp`,
      `${CU}/THE-ONE-C-U-8-scaled.webp`,
      `${CU}/THE-ONE-C-U-2-scaled.webp`,
    ],
  },
];
