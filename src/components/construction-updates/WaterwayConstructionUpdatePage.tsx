...
const HERO_IMAGE = "/assets/images/v2/project-featured-images/waterway/Waterway-pic-2.webp";
...
const WATERWAY_GALLERY: GalleryMonth[] = [
  {
    month: "February 2026",
    images: [
      `${CU}/waterway-construction-updates-feb-2026-4.webp`,
      `${CU}/waterway-construction-updates-feb-2026-3.webp`,
      `${CU}/waterway-construction-updates-feb-2026-2.webp`,
      `${CU}/waterway-construction-updates-feb-2026-5.webp`,
    ],
  },
  {
    month: "August 2025",
    images: [
      `${CU}/The-Waterway-Construction-Update-6.webp`,
      `${CU}/The-Waterway-Construction-Update-12.webp`,
      `${CU}/The-Waterway-Construction-Update-3.webp`,
      `${CU}/The-Waterway-Construction-Update-2.webp`,
      `${CU}/The-Waterway-Construction-Update-1.webp`,
    ],
  },
  {
    month: "June 2025",
    images: [
      `${CU}/2K6A3768-HDR-scaled.webp`,
      `${CU}/2K6A3780-HDR.webp`,
      `${CU}/2K6A3777-HDR-scaled.webp`,
    ],
  },
  {
    month: "April 2024",
    images: [
      `${CU}/2K6A3756-HDR-scaled.webp`,
      `${CU}/2K6A3759-HDR-scaled.webp`,
      `${CU}/2K6A3762-HDR-scaled.webp`,
    ],
  },
];
