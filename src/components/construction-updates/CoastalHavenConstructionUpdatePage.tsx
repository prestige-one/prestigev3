...
const HERO_IMAGE =
  "/assets/images/v2/project-featured-images/coastal-haven/Coastal-Haven.webp";

const CU_IMG = CONSTRUCTION_GALLERY_IMAGE_BASE;

const COASTAL_HAVEN_GALLERY: GalleryMonth[] = [
  {
    month: "March 2026",
    images: [
      `${CU_IMG}/coastal-construction-updates-mar-2026-6.webp`,
      `${CU_IMG}/coastal-construction-updates-mar-2026-2.webp`,
      `${CU_IMG}/coastal-construction-updates-mar-2026-5.webp`,
      `${CU_IMG}/coastal-construction-updates-mar-2026-7.webp`,
      `${CU_IMG}/coastal-construction-updates-mar-2026-1.webp`,
    ],
  },
  {
    month: "February 2026",
    images: [
      `${CU_IMG}/coastal-haven-construction-updates-feb-2026-5.webp`,
      `${CU_IMG}/coastal-haven-construction-updates-feb-2026-3.webp`,
      `${CU_IMG}/coastal-haven-construction-updates-feb-2026-2.webp`,
      `${CU_IMG}/coastal-haven-construction-updates-feb-2026-1.webp`,
    ],
  },
  {
    month: "August 2025",
    images: [
      `${CU_IMG}/Coastal-Haven-Construction-Update-8-scaled.webp`,
      `${CU_IMG}/Coastal-Haven-Construction-Update-1-scaled.webp`,
      `${CU_IMG}/Coastal-Haven-Construction-Update-10-scaled.webp`,
    ],
  },
  {
    month: "May 2025",
    images: [`${CU_IMG}/PONE9894-copy-scaled.webp`, `${CU_IMG}/PONE9902-copy-scaled.webp`],
  },
];
