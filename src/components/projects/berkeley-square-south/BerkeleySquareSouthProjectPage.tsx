...
const HERO_IMG =
  "/assets/images/v2/project-featured-images/berkeley/Berkeley-Square-South.webp";
const HERO_VIDEO =
...
const PROJECT_WIDE_VIDEO =
  "/assets/images/v2/project-features-videos/Berkeley-Square-South.mp4";
    ...
    <>
      ...
      <section className="po-project-page-hero">
        ...
        <div className="po-project-page-hero-content">
          ...
          <div className="po-project-page-hero-actions">
            <ProjectRegisterInterestButton projectName="Berkeley Square South by Prestige One" />
      ...
      <section className="po-project-page-gallery-section po-project-page-gallery-section--compact" aria-labelledby="berkeley-outdoor-heading">
        <div className="container">
          ...
          <p className="po-project-page-gallery-lead">A closer look at selected spaces that define Berkeley Square South living.</p>
          <div className="po-project-page-gallery-grid">
