  ...
  <div class="dgm-step-area pb-50">
    <div class="container container-1230">
      <div class="row align-items-end">
        <!-- First column (static title + button) -->
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="dgm-step-item p-relative dgm-step-space-1 mb-80">
            <h4 class="dgm-step-title mb-25">
              Explore the <br>
              creative process
            </h4>
            <NuxtLink class="tp-btn-yellow-green green-solid" to="/contact">
              <i>
        ...
        >
          <div
            class="dgm-step-item p-relative mb-80"
            :class="step.cls"
          >
            <span class="dgm-step-number">{{ step.number }}</span>
            <h4 class="dgm-step-title-sm">{{ step.title }}</h4>
            <p>{{ step.desc }}</p>
          </div>
        </div>
      </div>
...
const steps = [
  {
    ...
    number: "01",
    title: "Research",
    desc: "Focussed on understanding your business requirements, users and problems",
    cls: "dgm-step-space-2",
  },
  {
    id: 2,
    number: "02",
    title: "Ideation & design",
    desc: "In this stage we work closely to come up with lots of solutions & finalize design",
    cls: "dgm-step-space-3",
  },
  {
    id: 3,
    number: "03",
    title: "Development",
    desc: "I develop your product in Webflow and help you with maintaining it.",
    cls: "dgm-step-space-4",
  },
];
</script>