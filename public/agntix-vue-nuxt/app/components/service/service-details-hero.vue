<template>
  <div class="ar-hero-area p-relative pt-190 pb-100" :style="{backgroundImage:`url(${bg_img})`}">
          ...
          <div class="row justify-content-center">
              <div class="col-xl-12">
                  <div class="ar-hero-title-box service-5-heading tp_fade_anim mb-80" data-delay=".3">
                      ...
                      <h3 class="tp-career-title">Web and mobile <span class="shape-1">
                        <img src="/img/about-us/about-us-4/about-us-4-shape-1.png" alt="">
                      </span> <br>development</h3>
                  </div>
              </div>
          </div>
          <div class="row">
