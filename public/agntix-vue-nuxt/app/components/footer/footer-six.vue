<template>
  <footer>
    <!-- footer area start -->
    <div class="ar-footer-area pt-115 pb-75" data-bg-color="#111214" :style="{ backgroundColor: bg_clr }">
              ...
              <div class="col-xl-4 col-lg-6 col-md-8">
                  <div class="ar-footer-widget ar-footer-col-1 mb-40 tp_fade_anim" data-delay=".3">
                      <div class="ar-footer-logo mb-30">
                          <nuxt-link href="/">
                            <img data-width="140" src="/img/logo/logo-white.png" alt="logo" width="140">
                          </nuxt-link>
                      </div>
                      ...
                      <div class="ar-footer-widget-form">
                          <div class="ar-footer-widget-input p-relative">
                              ...
                              <button class="ar-footer-widget-btn" type="submit">
                                subscribe
                              </button>
                          </div>
                      </div>
    ...
    <div class="ar-copyright-area ar-copyright-ptb" data-bg-color="#111214" :style="{ backgroundColor: bg_clr }">
      <div class="container container-1430">
...
const bg_clr = isDark.value ? '#1b1b1d' : '#111214';
</script>