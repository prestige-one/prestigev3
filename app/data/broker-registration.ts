export const brokerRegistrationSlugs = [
  "uae-company",
  "uae-individual",
...
export type BrokerRegistrationSlug = (typeof brokerRegistrationSlugs)[number];

export interface BrokerRegistrationPageContent {
  heroTitle: string;
  heroIntro: string;
  sections: readonly {
    heading: string;
...
export interface BrokerFormDefinition {
  submitLabel: string;
  blocks: readonly {
    title: string;
...
export const brokerRegistrationCards: readonly {
  slug: BrokerRegistrationSlug;
  title: string;
  kind: "company" | "individual";
}[] = [
  { slug: "uae-company", title: "UAE company", kind: "company" },
  { slug: "uae-individual", title: "UAE individual", kind: "individual" },
  { slug: "international-company", title: "International company", kind: "company" },
  { slug: "international-individual", title: "International individual", kind: "individual" },
];

export const brokerRegistrationPageContent: Record<BrokerRegistrationSlug, BrokerRegistrationPageContent> = {
  "uae-company": {
...
const imageOrPdf = ".pdf,.jpg,.jpeg,.png";

export const brokerRegistrationForms: Record<BrokerRegistrationSlug, BrokerFormDefinition> = {
  "uae-company": {
    submitLabel: "Submit",
    blocks: [
      {
      ...
      },
      {
        ...
        fields: [
          { kind: "file", name: "fileTradeLicence", label: "Trade licence copy", required: true, accept: imageOrPdf },
          { kind: "file", name: "fileRera", label: "RERA / broker registration proof", accept: imageOrPdf },
          { kind: "file", name: "fileVat", label: "VAT certificate", accept: imageOrPdf },
          { kind: "file", name: "fileSignatoryId", label: "Signatory Emirates ID or passport", required: true, accept: imageOrPdf },
        ],
      },
      {
        title: "Declaration",
    ...
    blocks: [
      ...
      },
      {
        ...
        fields: [
          ...
          { kind: "select", name: "yearsExperience", label: "Years in UAE real estate", required: true, options: experienceOptions },
          {
            kind: "select",
            name: "affiliation",
      ...
      },
      {
        title: "Documents (upload)",
        fields: [
          { kind: "file", name: "fileEid", label: "Emirates ID copy", required: true, accept: imageOrPdf },
          { kind: "file", name: "filePassport", label: "Passport copy", required: true, accept: imageOrPdf },
          { kind: "file", name: "fileReraCard", label: "RERA card / permit copy", required: true, accept: imageOrPdf },
  ...
  "international-company": {
    ...
    blocks: [
      ...
      },
      {
        ...
        fields: [
          { kind: "textarea", name: "registeredAddress", label: "Full registered address", required: true, rows: 4 },
        ],
      },
      {
      ...
      },
      {
        title: "Documents (upload)",
        fields: [
          { kind: "file", name: "fileIncorporation", label: "Certificate of incorporation / registration", required: true, accept: imageOrPdf },
          { kind: "file", name: "fileAuth", label: "Board resolution or authorisation letter", accept: imageOrPdf },
          { kind: "file", name: "fileSignatoryPassport", label: "Passport of authorised signatory", required: true, accept: imageOrPdf },
        ],
      },
      {
        title: "Declaration",
    ...
    blocks: [
      ...
      },
      {
        ...
        fields: [
          ...
          { kind: "select", name: "yearsExperience", label: "Years in real estate", required: true, options: experienceOptions },
          {
            kind: "select",
            name: "heardAbout",
...
export function isBrokerRegistrationSlug(value: string): value is BrokerRegistrationSlug {
  return (brokerRegistrationSlugs as readonly string[]).includes(value);
}
