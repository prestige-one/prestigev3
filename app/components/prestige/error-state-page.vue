      ...
      <main class="prestige-error" :aria-labelledby="headingId">
        ...
        <div class="container container-1430 prestige-error__inner">
          ...
          <h1 :id="headingId" class="prestige-error__title">
            {{ notFound ? "This address leads somewhere else." : "We couldn't complete that request." }}
          </h1>
          ...
          <div class="prestige-error__actions">
            <button type="button" class="prestige-btn" @click="$emit('returnHome')">
              Return home
            </button>
            <nuxt-link :to="localePath('/projects')" class="prestige-btn prestige-btn--ghost">
              Explore projects
            </nuxt-link>
          </div>
        </div>
