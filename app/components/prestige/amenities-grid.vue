<template>
  <section class="prestige-section prestige-amen">
    <div class="container container-1430">
      <div class="row">
        <div class="col-xl-4 mb-40">
          ...
          <h2 class="prestige-heading tp_fade_anim" :class="headingClass" data-delay=".3">{{ title }}</h2>
        ...
        <div class="col-xl-8">
          <div class="row">
            <div
              v-for="(a, i) in items"
              :key="i"
              class="col-md-6 mb-20 tp_fade_anim"
              data-delay=".2"
            >
              <div class="prestige-amen__item">
