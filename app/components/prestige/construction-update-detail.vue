              ...
              <div class="container container-1430">
                <section v-if="project.technicalSpecifications?.length" class="cu-specs" aria-labelledby="cu-specs-title">
                  ...
                  <div class="cu-specs__grid">
                    <article v-for="item in project.technicalSpecifications" :key="item" class="cu-specs__card">
                      <span class="prestige-cu-specs__check" aria-hidden="true">
...
.prestige-cu-specs__check { display: grid; width: 42px; height: 42px; place-items: center; border: 1px solid rgba(255,255,255,.24); border-radius: 50%; color: rgba(255,255,255,.9); }
...
.cu-months button { position: relative; flex: 0 1 calc((100% - 48px) / 4); min-width: 0; height: 270px; overflow: hidden; border: 1px solid rgba(255,255,255,.2); border-radius: 5px; padding: 0; background: #151517; color: #fff; cursor: pointer; }
