<template>
  <div class="ar-hero-area pp-service-2 p-relative pb-45" :style="{'background-image': `url(${bg_img})`}">
      ...
      <span>
        <svg xmlns="http://www.w3.org/2000/svg" width="84" height="84" viewBox="0 0 84 84" fill="none">
          <path
            ...
            :stroke="isDark?'#ffff':'#030303'" stroke-width="1.5" />
        </svg>
      </span>
    </div>
      ...
      <div class="row justify-content-center">
        <div class="col-xl-12">
          <div class="pp-service-2-title-box">
            <h3 class="ar-about-us-4-title tp-char-animation">Services & <br>
              Capabilities</h3>
          </div>
        </div>
      </div>
...
const bg_img = isDark.value ? '/img/blog/blog-masonry/blog-bradcum-bg.png' : '/img/about-us/about-us-4/about-us-4-bg.png';
</script>