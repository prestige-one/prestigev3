<template>
  <div>
    <a href="https://www.facebook.com/ByPrestigeOne/" target="_blank">
        <span>
    ...
    <a href="https://www.linkedin.com/company/byprestigeone" target="_blank">
        <span>
    ...
    <a href="https://www.instagram.com/byprestigeone/" target="_blank">
        <span>
     ...
     <a href="https://www.youtube.com/@byprestigeone" target="_blank">
        <span>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none">
                <path d="M23.498 6.186a2.994 2.994 0 0 0-2.107-2.117C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.391.524A2.994 2.994 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a2.994 2.994 0 0 0 2.107 2.117c1.886.524 9.391.524 9.391.524s7.505 0 9.391-.524a2.994 2.994 0 0 0 2.107-2.117C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.75 15.568V8.432L15.818 12l-6.068 3.568z" fill="currentcolor" />
            </svg>
        </span>
    </a>
