<template>
  <section id="what-drives-us" class="prestige-drives-area pt-40 pb-80">
    <div class="container container-1430">
      ...
      <div class="prestige-drives-grid">
        <article
          ...
          :key="principle.title"
          class="prestige-drives-card tp_fade_anim"
...
.prestige-drives-card {
  position: relative;
  min-height: clamp(360px, 28vw, 450px);
  overflow: hidden;
...
@media (hover: hover) {
  .prestige-drives-card:hover .prestige-drives-image {
