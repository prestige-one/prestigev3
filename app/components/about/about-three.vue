        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="dgm-about-thumb-wrap p-relative">
                    <img class="tp_fade_anim" data-delay=".3" data-fade-from="left" src="/img/home-03/about/about-1.jpg" alt="">
                    <img class="dgm-about-thumb-1 tp_fade_anim" data-speed="1.1" data-delay=".5" src="/img/home-03/about/about-2.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="dgm-about-right">
                    ...
                    <div class="dgm-about-content">
                        ...
                        <div class="tp_fade_anim" data-delay=".5">
                            <nuxt-link class="tp-btn-yellow-green green-solid btn-60 mb-50" href="/about-us">
                                <span>
                            ...
                            <div class="dgm-about-review-box d-inline-flex align-items-center">
                                ...
                                <div class="dgm-about-ratting">
                                    ...
                                    <div class="dgm-about-ratting-icon">
                                        <span><svg-star-one fill="currentcolor"/></span>{{" "}}
                                        <span><svg-star-one fill="currentcolor"/></span>{{" "}}
                                        <span><svg-star-one fill="currentcolor"/></span>{{" "}}
                                        <span><svg-star-one fill="currentcolor"/></span>{{" "}}
                                        <span><svg-star-one fill="currentcolor"/></span>
