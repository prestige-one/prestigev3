          ...
          <div class="row">
              <div class="col-xl-3">
                  <div class="tp-shop-about-thumb">
                      <div class="img-1">
                          <img data-speed="1.1" src="/img/shop-home/about/about-2.jpg" alt="">
                      </div>
                      <div class="img-2">
                          <img data-speed="1.2" src="/img/shop-home/about/about-1.jpg" alt="">
                      </div>
                  </div>
              </div>
              <div class="col-xl-6">
                  <div class="tp-shop-about-middle">
                      <div class="tp-shop-about-circle-text text-center">
                          <img src="/img/shop-home/about/circle-text.jpg" alt="">
                      </div>
                      <div class="tp-shop-about-content text-center">
                          ...
                          <div class="tp-shop-about-btn tp_fade_anim" data-delay=".3" data-fade-from="top" data-ease="bounce">
                              <nuxt-link class="tp-checkout-btn border-style" href="/about-us">
                                  More About Us
                                  <span>
                      ...
                      <div class="tp-shop-about-thumb">
                          <div class="img-3">
                              <img data-speed=".9" src="/img/shop-home/about/about-3.jpg" alt="">
                          </div>
                      </div>
                  </div>
              </div>
              <div class="col-xl-3">
                  <div class="tp-shop-about-thumb text-end">
                      <div class="img-4 z-index-1">
                          <img data-speed="1.1" src="/img/shop-home/about/about-4.jpg" alt="">
                      </div>
                      <div class="img-5">
                          <img data-speed="1.2" src="/img/shop-home/about/about-5.jpg" alt="">
                      </div>
                      <div class="img-6">
                          <img data-speed="1.1" src="/img/shop-home/about/about-6.jpg" alt="">
                      </div>
                  </div>
              </div>
          </div>
