<template>
   <div class="tp-hero-2-wrapper">
      <div class="tp-hero-2-area include-bg pt-180 pb-160" data-background="/img/home-02/hero/hero-bg.jpg" style="background-image: url(/img/home-02/hero/hero-bg.jpg);">
          <div class="container">
              <div class="row">
                  <div class="col-xl-12">
                      <div class="tp-hero-2-content text-center mb-25">
                          <span class="tp-hero-2-subtitle tp_fade_anim" data-delay=".3">Best-in-class local <br> benefits for everyone, everywhere
                          </span>
                          <h1 class="tp-hero-2-title tp_fade_anim" data-delay=".5">Design Agency</h1>
                      </div>
                  </div>
              </div>
              <div class="row">
                  <div class="col-md-6">
                      <div class="tp-hero-2-avater-box d-flex align-items-center justify-content-center justify-content-md-start tp_fade_anim" data-delay=".7" data-on-scroll="3">
                          <div class="tp-hero-2-avater">
                              <img src="/img/home-02/hero/avater.png" alt="">
                          </div>
                  ...
                  <div class="col-md-6">
                      <div class="tp-hero-2-btn-box tp-light-bg-btn text-center text-md-end tp_fade_anim" data-delay=".7" data-on-scroll="3">
                          <nuxt-link class="tp-btn-border" href="/portfolio-details-creative-slider">
      ...
      <div v-if="showImgs" class="tp-hero-2-img-wrap d-none d-md-block">
          <div class="container container-1230">
              <div class="tp-hero-2-img-box mb-150">
                  <div class="row">
                      <div class="col-12">
                          <div class="tp-heo-2-img tp-hero-2-img-1">
                              <img src="/img/home-02/hero/hero-1.jpg" alt="">
                          </div>
                      </div>
                      <div class="col-12">
                          <div class="tp-heo-2-img tp-hero-2-img-2 text-end">
                              <img src="/img/home-02/hero/hero-2.jpg" alt="">
                          </div>
                      </div>
                      <div class="col-12">
                          <div class="tp-heo-2-img tp-hero-2-img-3 text-end">
                              <img src="/img/home-02/hero/hero-3.png" alt="">
                          </div>
                      </div>
                  </div>
              </div>
              <div class="tp-hero-2-img-box mb-150">
                  <div class="row">
                      <div class="col-12">
                          <div class="tp-heo-2-img tp-hero-2-img-1">
                              <img src="/img/home-02/hero/hero-4.jpg" alt="">
                          </div>
                      </div>
                      <div class="col-12">
                          <div class="tp-heo-2-img tp-hero-2-img-2 text-end">
                              <img src="/img/home-02/hero/hero-5.jpg" alt="">
                          </div>
                      </div>
                      <div class="col-12">
                          <div class="tp-heo-2-img tp-hero-2-img-3 text-end">
              ...
              <div class="tp-hero-2-img-box last-item">
                  <div class="row">
                      <div class="col-12">
                          <div class="tp-heo-2-img tp-hero-2-img-1">
                              <img src="/img/home-02/hero/hero-6.jpg" alt="">
                          </div>
                      </div>
                      <div class="col-12">
                          <div class="tp-heo-2-img tp-hero-2-img-2 text-end">
                              <img src="/img/home-02/hero/hero-7.jpg" alt="">
                          </div>
                      </div>
                  </div>
              </div>
