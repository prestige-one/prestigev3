<template>
  <div class="tp-testimonial-15-area pt-180 pb-180 p-relative z-index-1 cursor-style" :class="{'coffe-bg': isDark }">
      <div class="tp-testimonial-15-bg">
          <img src="/img/home-15/testimonial/testi-bg.png" alt="">
      </div>
      <div class="container container-1230">
          <div class="row">
              <div class="col-xl-7">
                  <div class="tp-testimonial-15-content z-index-5 p-relative">
                      <p>
