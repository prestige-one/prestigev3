      ...
      <div id="smooth-wrapper">
        <div id="smooth-content">
          <main>
            ...
            <div class="tp-service-4-padding-area" data-bg-color="#F6F8EF" style="background-color: #F6F8EF;">

              <!-- service area start -->
              <service-two top-cls="pt-120 z-index-1" wrap-cls="dgm-service-white" :dark-text="true" />
              <!-- service area end -->
