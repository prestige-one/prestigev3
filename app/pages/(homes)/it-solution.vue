...
useSeoMeta({
  ...
  ogTitle: "Agntix - It Solution vue nuxt Template",
  description: "Comprehensive IT solutions for your business. Agntix delivers cutting-edge technology services and consulting.",
  ogDescription: "Comprehensive IT solutions for your business. Agntix delivers cutting-edge technology services and consulting.",
...
onMounted(async () => {
  ...
  if (smoothWrapper) {
    smoothWrapper.style.backgroundColor = '#FDF7F4';
