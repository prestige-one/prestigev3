<template>
  <div>
    <nuxt-layout>
      ...
      <!-- header area start -->
      <header-seventeen top-cls="header-inner-white tp-header-blur sticky-black-bg @@class" container-cls="1750" />
      <!-- header area end -->
      ...
      <div id="smooth-wrapper">
        <div id="smooth-content">
          ...
          <main>
            ...
            <portfolio-details-custom-light-area />
...
useSeoMeta({
  title: "Agntix - Portfolio details custom vue nuxt Template",
});
